...
cv_para = ShuffleSplit(n_splits=3, test_size=0.05, random_state=1)
print 'cross validation score of rf_model: '+str(cross_val_score(rf_model, X_train, Y_train,
     cv=cv_para, scoring='r2').mean())
...
rf_model.predict([[34.034515,-84.707349]])
...
nn_model = MLPRegressor(hidden_layer_sizes=(500, ), activation='relu',
